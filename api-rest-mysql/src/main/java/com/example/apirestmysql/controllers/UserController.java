package com.example.apirestmysql.controllers;
...
import com.example.apirestmysql.services.UserService;


//Indicamos que es un controlador rest
@RestController
@RequestMapping("/demo") //esta sera la raiz de la url, es decir http://localhost:8080/demo/
